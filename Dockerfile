...
ENV BAR1=aceRestDemo.bar

################-PJ-Modified location of download###############
################-PJ-Modified install path to refelct 11.0.0.2###############
...
## Not sure what else to do here yet
...
RUN bash -c 'mqsisetdbparms -w /home/aceuser/ace-server -n MQ::mq1 -u pjessup -p d2_kuslE-ppRTU-BbtEisB5vlruhBhj0CrUGDpXNbtxG'
